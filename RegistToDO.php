<?php
    ...
    if(isset($_POST['work']) && ($_POST['doday'])){
		...
		$dbm = new DBManager();
		$dbm->insertTODO($_SESSION['userid'],$_POST['doday'],$_POST['work']);
        ...
        <form action="RegistToDO.php" method="post">
            <div style="width:400px;margin-right:auto;margin-left:auto;margin-top:auto;padding:30px;">
                <table>
                    ...
                    <tr>
                        <td colspan=2>
                            <input type="submit" value="登録" style="background-color:#0066CC;color:#FFFFFF;width:260px;margin-top:50px;margin-left:auto;margin-right:auto;border:0;">
                        </td>
                    </tr>
                </table>
            </div>
